...
class PromosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promo" do
    assert_difference('Promo.count') do
      post promos_url, params: { promo: { school_code: @promo.school_code, slug: @promo.slug, title: @promo.title, user_id: @promo.user_id } }
    end
  ...
  test "should update promo" do
    patch promo_url(@promo), params: { promo: { school_code: @promo.school_code, slug: @promo.slug, title: @promo.title, user_id: @promo.user_id } }
